        ...
        <View style={[styles.filterRoot, { backgroundColor: colors.background }]}>
            ...
            >
                ...
                <View style={styles.budgetVisualizer}>
                    ...
                    {/* Visual Slider Mockup (High Fidelity Elements) */}
...
const styles = StyleSheet.create({
    ...
    trackStep: { position: "absolute", width: 14, height: 14, borderRadius: 7, top: 8, marginLeft: -7 },
